(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('d3'), require('d3-scale-chromatic'), require('leaflet')) :
	typeof define === 'function' && define.amd ? define(['d3', 'd3-scale-chromatic', 'leaflet'], factory) :
	(global.datahub = factory(global.d3,global.d3,global.L));
}(this, (function (d3,colorBrewer,L) { 'use strict';
...
var template$1 = function(config) {
...
var eventsPanel$1 = function(config) {
...
var tableChart = function(config) {
    ...
    var render = function() {
        chartCache = multi$1(configCache);
    };
...
var template$2 = function(config) {
...
var verticalLines$1 = function(config) {
...
var verticalChart = function(config) {
    ...
    var render = function() {
        chartCache = multi$2(configCache);
    };
...
var template$3 = function(config) {
...
var waterfallChart = function(config) {
    ...
    var render = function() {
        chartCache = multi$3(configCache);
    };
...
var defaultConfig$1 = function(config) {
    return {
        margin: config.margin || {right: 20, left: 20},
        unit: null,
        colorScale: config.colorScale || colorScales.equalizedSpectral
    }
};

var template$4 = function(config) {
...
var dataGridLayer = function() {
    ...
    api.render = function(_data) {
        ...
        var data$$1 = new Uint32Array(buf);
...
var selectorMap = function(config) {
    ...
    selectionMap.addPolygons = function(data$$1) {
        removeAllPolygons();

        data$$1.forEach(function(geojson) {
...
var rasterMap = function(_config) {
    ...
    function renderRaster(data$$1) {
        gridData = data$$1;
        var dataSorted = data$$1.uniqueValues.sort(function(a, b) {
            return a - b
        });
